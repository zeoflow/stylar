...
class StylarAdapterImpl extends StylarAdapter
{
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position)
    {
        ...
        entry.bindHolder(stylar, holder, node);
    }
    ...
    static class BuilderImpl implements Builder
    {
        ...
        public StylarAdapter build()
        {
            ...
            return new StylarAdapterImpl(entries, defaultEntry, reducer);
        }
    }
}
