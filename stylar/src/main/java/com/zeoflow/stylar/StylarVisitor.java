...
public interface StylarVisitor extends Visitor {
     ...
     * for the node (via {@link StylarSpansFactory#require(Class)} thus throwing an exception
     ...
     * uses {@link StylarSpansFactory#require(Class)}. This method uses {@link StylarSpansFactory#get(Class)}.
     *
     * @see #setSpansForNode(Node, int)
     */
