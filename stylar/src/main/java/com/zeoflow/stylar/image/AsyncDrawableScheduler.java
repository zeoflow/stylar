...
public abstract class AsyncDrawableScheduler
{
    ...
    public static void schedule(@NonNull final TextView textView)
    {
        ...
        final Integer lastTextHashCode =
            (Integer) textView.getTag(R.id.stylar_drawables_scheduler_last_text_hashcode);
        ...
        textView.setTag(R.id.stylar_drawables_scheduler_last_text_hashcode, textHashCode);
            ...
            && spans.length > 0)
        {
            ...
            if (textView.getTag(R.id.stylar_drawables_scheduler) == null)
            {
                final View.OnAttachStateChangeListener listener = new View.OnAttachStateChangeListener()
                {
                    ...
                    public void onViewDetachedFromWindow(View v)
                    {
                        ...
                        v.setTag(R.id.stylar_drawables_scheduler, null);
                    }
                };
                textView.addOnAttachStateChangeListener(listener);
                textView.setTag(R.id.stylar_drawables_scheduler, listener);
            }
    ...
    public static void unschedule(@NonNull TextView view)
    {
        ...
        // @since 4.0.0
        if (view.getTag(R.id.stylar_drawables_scheduler_last_text_hashcode) == null)
        {
            return;
        }
        view.setTag(R.id.stylar_drawables_scheduler_last_text_hashcode, null);
