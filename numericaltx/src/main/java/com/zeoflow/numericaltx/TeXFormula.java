...
import com.zeoflow.numericaltx.awt.GraphicsEnvironment;
import com.zeoflow.numericaltx.awt.Toolkit;
...
public class TeXFormula {
    ...
    static {
        ...
        try {
            DefaultTeXFont.registerAlphabet((AlphabetRegistration) Class.forName("com.zeoflow.numericaltx.cyrillic.CyrillicRegistration").newInstance());
            DefaultTeXFont.registerAlphabet((AlphabetRegistration) Class.forName("com.zeoflow.numericaltx.greek.GreekRegistration").newInstance());
        } catch (Exception e) { }
