...
The Stylar contributing policies and procedures can be found in the
main Stylar documentation repository’s
[contributing page](https://github.com/zeoflow/stylar/blob/CONTRIBUTING.md).
...
Stylar for Android has JVM tests as well as Emulator tests.
...
whitespace, Stylar uses code conventions and styles to
