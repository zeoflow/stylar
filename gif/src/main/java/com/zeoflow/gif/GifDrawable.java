...
import com.zeoflow.gif.transforms.CornerRadiusTransform;
import com.zeoflow.gif.transforms.Transform;
...
public class GifDrawable extends Drawable implements Animatable, MediaPlayerControl
{
    ...
    {
        if (x >= mNativeInfoHandle.getWidth())
        { //need to check explicitly because reused bitmap may be larger
